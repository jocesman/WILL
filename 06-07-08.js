...
function crearClasePersona() {
  class Persona {
    ...
    addFriend(nombre, edad) {
      // El método 'addFriend' recibe un string 'nombre' y un entero 'edad' y 
    ...
    addHobby(hobby) {
      // El método 'addHobby' recibe un string 'hobby' y debe agregarlo al 
    ...
    getFriends() {
      // El método 'getFriends' debe retornar un arreglo con sólo los nombres 
      // del arreglo de amigos de la persona.
      // Ej:
    ...
    getHobbies() {
      ...
      // Tu código aca:
      return this.hobbies.map(function(objeto){
        return objeto;
      })
    ...
    getPromedioEdad() {
      // El método 'getPromedioEdad' debe retornar el promedio de edad de los 
